...
如果某些东西你买来后能够给你带来产出，或者产生的价值会高于你最初的投资，它就算是生产力工具，而别的东西则会消耗你的收入，它就不算是生产力工具。

具体而言，生产力应用就是用来工作、协作、输入、输出、生产、创作的应用，按照不同的系统和平台，可以分为 Mac、iOS 和 Win 平台，以下是我与这些应用的故事。

个人对于应用的最大需求是文字内容的生产，清单应用按个人使用频率与生产贡献排序。

- 2019-03-10 更新生产力应用定义
- 2019-02-23 更新完毕集合成文。
- 2018-12-13 以卡片形式更新，首发笨方法学写作知识星球


> 首发且不定期更新地址：https://github.com/cnfeat/GoodThingList/blob/master/GoodMacAppList.md

如果你喜欢这篇文章，不妨点个star，谢谢。
